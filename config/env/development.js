...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + ('/' + (process.env.DB_NAME || 'mean') + '-dev'),
    options: {
      user: '',
      pass: ''
    },
  ...
  gcm: {
    api: process.env.GCM_API,
    secret: process.env.GCM_SECRET
  },
  mailer: {
